<?php
$naslov = "Moj prvi PHP dokument — vježba-1c"; 
$autor  = "Denis Hernaut"; 
$link   = "https://nati-tisak.hr/"; 
$linkInfo   = "https://nati-tisak.hr/#onama";
$linkNatrag = "vjezba-1b.php";
$opis = "Ova vježba prikazuje kombinaciju PHP-a i HTML-a uz osnovni CSS dizajn.";
?> 
...
<body>
  <main class="wrap">
    ...
    <p><a class="btn" href="<?php echo htmlspecialchars($linkInfo); ?>" target="_blank" rel="noopener">Saznaj više o NATI TISAK</a></p>
    <p><a href="<?php echo htmlspecialchars($linkNatrag); ?>">Natrag na vježba 1b</a></p>

    <footer>&copy; <?php echo date('Y'); ?> — Vježba 1c</footer>
  </main>
</body>
</html>
<!-- vjezba-1c.php -->